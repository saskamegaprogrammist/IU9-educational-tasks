...
public class Position implements Cloneable {
    ...
    public boolean isKeySymbol() {
        if (this.index != this.fileLength) {
            ...
            return value == Utils.delimiter || value == Utils.dot
                    || value == Utils.equals || value == Utils.closeBracketSquare
                    || value == Utils.plus || value == Utils.openBracketSquare
                    || value == Utils.question || value == Utils.star;
        }
        return false;
    }
    ...
    public boolean isPlus() {
        return (this.index != this.fileLength && this.file.charAt(this.index) == Utils.plus);
    }

    public boolean isQuestion() {
        return (this.index != this.fileLength && this.file.charAt(this.index) == Utils.question);
    }

    public boolean isStar() {
        return (this.index != this.fileLength && this.file.charAt(this.index) == Utils.star);
    }

    public boolean isCloseBracketSquare() {
        return (this.index != this.fileLength && this.file.charAt(this.index) == Utils.closeBracketSquare);
    }

    public boolean isOpenBracketSquare() {
        return (this.index != this.fileLength && this.file.charAt(this.index) == Utils.openBracketSquare);
    }
